...
def main():
    ...
    <style>
    .stApp {
        background-image: url('https://wallpaperaccess.com/full/731608.jpg');
    ...
    st.markdown('<h4 class="shadow-text">Using Streamlit App / Supervised Learning</h4>', unsafe_allow_html=True)
